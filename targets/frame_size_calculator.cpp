...
void og::frame_size_calculator::do_power_node(og::power_node * const node, int lvl) {
  // EMPTY
}

void og::frame_size_calculator::do_while_node(og::while_node * const node, int lvl) {
  // EMPTY
}

void og::frame_size_calculator::do_do_while_node(og::do_while_node * const node, int lvl) {
  // EMPTY
}
